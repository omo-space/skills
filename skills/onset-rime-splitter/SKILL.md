---
name: onset-rime-splitter
description: Produce reviewable segmented word/explanation with validation, safety checks, and structured output. Use when a teacher, tutor, or literacy specialist needs this bounded workflow and will review the result before use.
---

# Onset-Rime Splitter

Produce segmented word/explanation as a bounded workflow contract derived from the inspected
PhonicsMaker behavior, without claiming deployment or classroom approval.

## When to use

- A teacher, tutor, or literacy specialist needs segmented word/explanation.
...
3. **Perform:** Produce segmented word/explanation using only the validated request and the server-owned workflow.
